...
describe('compileWorkflow', () => {
  ...
  it('generates repository-native workflow assets', () => {
    ...
    assert.match(webConsole.content, /validateWorkflowDraft/)
    assert.match(webConsole.content, /id="download-workflow-json"/)
    assert.match(webConsole.content, /opt\.workflow\.json/)
